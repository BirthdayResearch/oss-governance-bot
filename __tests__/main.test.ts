...
describe('getGovernance', () => {
  it('should error not get from context', async function () {
    ...
    await expect(getGovernance()).rejects.toThrow('Could not get pull_request or issue from context');
  });
    ...
    it('should be pull request', async function () {
      ...
      github.context.payload = {
        ...
        issue: {
          number: 1,
          pull_request: {
            diff_url: 'https://github.com/BirthdayResearch/oss-governance-bot/pull/9.diff',
            html_url: 'https://github.com/BirthdayResearch/oss-governance-bot/pull/9',
            patch_url: 'https://github.com/BirthdayResearch/oss-governance-bot/pull/9.patch',
            url: 'https://api.github.com/repos/BirthdayResearch/oss-governance-bot/pulls/9',
          },
        },
      };
